...
<template>
  <BasicLayout :collapsed="layoutSetting.collapsed" :theme="layoutSetting.theme" :menu-data="userStore.menuData"
    ...
    @update:open-keys="layoutMenu.handleOpenKeys" @update:selected-keys="layoutMenu.handleSelectedKeys"
    ...
    <a-watermark h-full flex flex-col flex-1 content="Snake Pro">
      <RouterView>
  ...
  <SettingDrawer v-model:open="layoutSetting.drawerVisible" :theme="layoutSetting.theme"
    :color-primary="layoutSetting.colorPrimary" :color-weak="layoutSetting.colorWeak" :multi-tab="layoutSetting.multiTab"
    :multi-tab-fixed="layoutSetting.multiTabFixed" v-bind="layoutProps" @setting-change="appStore.changeSettingLayout" />
</template>
